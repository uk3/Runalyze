...
CREATE TABLE IF NOT EXISTS `runalyze_training` (
  ...
  `isvirtualpower` bool NOT NULL DEFAULT '0',
  `normalizedpower` int(4) NOT NULL DEFAULT '0',
  `vipower` float DEFAULT NULL,
  ...
  `arr_powerdistribution` longtext CHARACTER SET latin1 COLLATE latin1_general_ci,
